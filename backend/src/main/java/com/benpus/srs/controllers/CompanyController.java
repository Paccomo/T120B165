...
//        }
    ...
    @PostMapping
    public ResponseEntity<Object> addCompany(@RequestBody NewCompanyRequest request, HttpServletRequest requestFull) {
        String errorMsg = "", name, address, postal, city, phone, email, website, fk_user;

//        String authHeader = requestFull.getHeader("Authorization");
//        if (authHeader != null && authHeader.startsWith("Bearer ")) {
//            String jwt = authHeader.substring(7);
//            String userEmail = jwtService.extractUserEmail(jwt);
//            System.out.println(userEmail);
